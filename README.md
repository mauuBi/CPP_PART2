# 🧪 C++ Modules - Part 2: Advanced Logic & Templates

The second half of the C++ journey at **42 Paris**. This repository focuses on the more advanced and "modern" aspects of the language: **Exception handling**, **Casting**, **Templates**, and the **STL**.
...
- **PmergeMe:** Implementing the Ford-Johnson algorithm for high-performance sorting.

## 🚀 Skills Showcased
- **Generic Programming:** Writing reusable, type-independent code.
- **Error Handling:** Designing robust systems that don't crash on bad input.
- **Algorithm Optimization:** Analyzing complexity (Big O notation) for sorting and searching.
